...
def sort_by_lengths(word_lists, data_lists, tag_lists):
    pairs = list(zip(word_lists, data_lists, tag_lists))
    ...
    word_lists, data_lists, tag_lists = list(zip(*pairs))

    return word_lists, data_lists, tag_lists, indices
