...
def bilstm_train_and_eval(train_data, dev_data, test_data,
                          word2id, tag2id, data2id, crf=True, remove_O=False):
    train_word_lists, train_tag_lists, train_data_lists = train_data
    dev_word_lists, dev_tag_lists, dev_data_lists = dev_data
    test_word_lists, test_tag_lists, test_data_lists = test_data
    ...
    bilstm_model = BILSTM_Model(vocab_size, data_size, out_size, crf=crf)
    # todo
    bilstm_model.train(train_word_lists, train_data_lists, train_tag_lists,
    ...
    pred_tag_lists, test_tag_lists = bilstm_model.test(
        test_word_lists, test_data_lists, test_tag_lists, word2id, data2id, tag2id)
